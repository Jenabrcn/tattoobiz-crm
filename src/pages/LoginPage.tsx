      ...
      <div className="w-full max-w-md p-8 bg-card rounded-2xl shadow-lg border border-border">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full py-2.5 px-4 bg-accent text-white font-medium rounded-lg hover:bg-accent/90 transition-colors disabled:opacity-50"
          >
            {submitting
              ? '...'
              : isSignUp
        ...
        <button
          ...
          className="w-full py-2.5 px-4 bg-white border border-border text-text-primary font-medium rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center gap-2"
        >
